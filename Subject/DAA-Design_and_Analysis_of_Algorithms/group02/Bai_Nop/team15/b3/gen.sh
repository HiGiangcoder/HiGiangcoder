...
g++ -std=c++17 -O2 -pipe -static -s gen_sub.cpp -o gen_sub
echo "[Compile] Done."
...
# Subtask 1 (50 tests)
echo "[Generate] test"
gen_and_run gen_sub 1 1 12
gen_and_run gen_sub 2 13 25
gen_and_run gen_sub 3 26 37
gen_and_run gen_sub 4 38 50
