...
g++ -std=c++17 -O2 -pipe -s -Wl,-rpath,/opt/homebrew/lib validator.cpp -o validator
g++ -std=c++17 -O2 -pipe -s -Wl,-rpath,/opt/homebrew/lib solution.cpp -o solution
g++ -std=c++17 -O2 -pipe -s -Wl,-rpath,/opt/homebrew/lib gen_sub1.cpp -o gen_sub1
g++ -std=c++17 -O2 -pipe -s -Wl,-rpath,/opt/homebrew/lib gen_sub2.cpp -o gen_sub2
echo "[Compile] Done."
...
gen_and_run gen_sub1 2 11 20
gen_and_run gen_sub1 3 21 30
gen_and_run gen_sub1 4 31 40

# Subtask 2 (60 tests)
echo "[Generate] Subtask 2"
gen_and_run gen_sub2 1 41 55
gen_and_run gen_sub2 2 56 70
