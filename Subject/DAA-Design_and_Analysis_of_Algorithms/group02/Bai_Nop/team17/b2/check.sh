...
[ -f validator.cpp ] && g++ -std=c++17 -O2 -pipe -s -Wl,-rpath,/opt/homebrew/lib validator.cpp -o validator 2>/dev/null || true
[ -f checker.cpp ]   && g++ -std=c++17 -O2 -pipe -s -Wl,-rpath,/opt/homebrew/lib checker.cpp   -o checker   2>/dev/null || true
