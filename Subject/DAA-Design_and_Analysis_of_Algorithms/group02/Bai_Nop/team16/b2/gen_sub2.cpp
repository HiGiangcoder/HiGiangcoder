...
int32_t main(int argc,char**argv){
    ...
    int n = (int)(type==1?  (R.pick(10000,100000)):
                  type==2?  (R.pick(10000,100000)):
                  type==3?  (R.pick(100000,100000)):
                            (R.pick(100000,100000)));
    int m;
    if (type==1) m=(int)R.pick(0,5);
    else if (type==2) m=(int)R.pick(100000,200000);
    else if (type==3) m=(int)R.pick(200000,200000);
