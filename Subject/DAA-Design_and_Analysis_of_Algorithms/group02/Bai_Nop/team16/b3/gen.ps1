...
Gen-And-Run "gen" 1 1 30
Gen-And-Run "gen" 2 31 41
Gen-And-Run "gen" 3 42 52
Gen-And-Run "gen" 4 53 73

#Write-Host "[Generate] Subtask 1"
#Gen-And-Run "gen_sub1" 1 1 20
#Gen-And-Run "gen_sub1" 2 21 31
#Gen-And-Run "gen_sub1" 3 32 36
#Gen-And-Run "gen_sub1" 4 37 40

#Write-Host "[Generate] Subtask 2"
#Gen-And-Run "gen_sub2" 1 41 61
#Gen-And-Run "gen_sub2" 2 62 74
#Gen-And-Run "gen_sub2" 3 75 84
#Gen-And-Run "gen_sub2" 4 85 100
