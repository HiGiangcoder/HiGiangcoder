...
int32_t main(int argc,char**argv){
    ...
    int n= (type==1? (int)R.pick(1,50) :
            type==2? (int)R.pick(900,1000) :
            type==3? (int)R.pick(1000,1000) :
                     (int)R.pick(1,1));
    cout << n << "\n";
    for (int i=0;i<n;i++){
        long long v;
        if (type == 1) v = (int)R.pick(-100000, 100000);
        else if (type == 2) v = (int)R.pick(-100000, -90000);
        else if (type == 3) v = (int)R.pick(90000, 100000);
