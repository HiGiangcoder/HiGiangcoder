...
gen_and_run("gen_sub1", 1, 1, 17)
gen_and_run("gen_sub1", 2, 18, 30)
gen_and_run("gen_sub1", 3, 31, 40)
gen_and_run("gen_sub1", 4, 41, 50)

print("[Generate] Subtask 2")
gen_and_run("gen_sub2", 1, 51, 67)
gen_and_run("gen_sub2", 2, 68, 80)
gen_and_run("gen_sub2", 3, 81, 90)
gen_and_run("gen_sub2", 4, 91, 100)
