...
gen_and_run("gen_sub1", 2, 11, 15)
gen_and_run("gen_sub1", 3, 16, 20)
gen_and_run("gen_sub1", 4, 21, 25)
gen_and_run("gen_sub1", 5, 26, 30)
gen_and_run("gen_sub1", 6, 31, 40)
gen_and_run("gen_sub1", 7, 41, 50)

print("[Generate] Subtask 2")
gen_and_run("gen_sub2", 1, 51, 60)
gen_and_run("gen_sub2", 2, 61, 65)
gen_and_run("gen_sub2", 3, 66, 70)
gen_and_run("gen_sub2", 4, 71, 75)
gen_and_run("gen_sub2", 5, 76, 80)
gen_and_run("gen_sub2", 6, 81, 90)
gen_and_run("gen_sub2", 7, 91, 100)
